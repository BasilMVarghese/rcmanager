...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("share/rcmanager/refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(186, 197))
